...
URL = "https://jisson-movie-bot.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://jisson-movie-bot.onrender.com".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://jisson-movie-bot.onrender.com".format(FQDN)
else:
    URL = "https://jisson-movie-bot.onrender.com".format(FQDN)
